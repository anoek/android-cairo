...
pixman-extra/pixman-srgb.c \
pixman-extra/cpu-features.c \

LIBPIXMAN_CFLAGS:=-D_USE_MATH_DEFINES -DPIXMAN_NO_TLS -DPACKAGE="android-canvas" -DUSE_ARM_NEON -DUSE_ARM_SIMD -DSIZE_MAX=0xfffffff
